...
// Block structure to hold DCT coefficients for Y, Cb, Cr channels
...
struct Image {
    ...
    uint block_height;
    uint block_width;
    uint block_height_real;  // May be adjusted for sampling factors
...
// * markers and array maps are generated by chatgpt
